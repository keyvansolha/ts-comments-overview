...
۳. **زمان آخرین به‌روزرسانی تحلیل نمایش داده نمی‌شود.** داده‌ی `updatedAt` خوانده
   و در ساختار داخلی (و ابزار پیشخوان) موجود است، ولی کارت هیچ تاریخ/ساعتی نشان
   نمی‌دهد؛ فقط اگر سرویس داده را کهنه اعلام کند یک نشان کوچک می‌آید.
