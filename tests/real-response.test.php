...
ts_co_assert_not_contains( '2026/09/22', $html, 'تاریخ آخرین به‌روزرسانی نمایش داده نمی‌شود' );
ts_co_assert_not_contains( 'آخرین به‌روزرسانی', $html, 'زمان به‌روزرسانی در کارت نیست' );
...
// عنوان و هشدار برجسته: کاربر باید بفهمد نظرات از اینترنت است، نه از فروشگاه ما.
ts_co_assert_contains( 'آنچه کاربران در اینترنت درباره این محصول می‌گویند', $html, 'عنوان، اینترنتی بودن نظرات را روشن می‌کند' );
ts_co_assert_contains( 'ts-comments-overview__notice', $html, 'هشدار برجسته‌ی منبع نظرات رندر می‌شود' );
ts_co_assert_contains( 'نه از خریداران تهران‌اسپیکر', $html, 'هشدار می‌گوید این نظرات از فروشگاه ما نیست' );
ts_co_assert_contains( 'کالای آسیب‌دیده یا مرجوعی', $html, 'هشدار، ایرادهای مربوط به فروشگاه‌های دیگر را صریح نام می‌برد' );
ts_co_assert_true(
	strpos( $html, 'ts-comments-overview__notice' ) < strpos( $html, 'ts-comments-overview__summary' ),
	'هشدار پیش از متن خلاصه می‌آید تا کاربر پیش از خواندن شکایت‌ها آن را ببیند'
);
